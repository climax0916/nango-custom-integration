...
import AuthorizationKey from 'middlewares/AuthorizationKey'
...
routes.get(
  ...
  asyncHandler(async function getAll(req: Request, res: Response) {
    const data = await DataService.getAll(req)
...
routes.post(
  '/:appId/apikey/data',
  AuthorizationKey,
  asyncHandler(async function createOne(req: Request, res: Response) {
    const formData = req.getBody();
    const data = await DataService.createOne(formData)
    const buildResponse = BuildResponse.get(data)
...
routes.delete(
  '/:appId/apikey/data/:id',
  AuthorizationKey,
  asyncHandler(async function removeOne(req: Request, res: Response) {
    const data = await DataService.removeOne(req.getParams('id'));
    const buildResponse = BuildResponse.get(data)
...
routes.put(
  '/:appId/apikey/data/:id',
  AuthorizationKey,
  asyncHandler(async function updateOne(req: Request, res: Response) {
    const formData = req.getBody()
    const data = await DataService.updateOne(req.getParams('id'), formData)
    const buildResponse = BuildResponse.get(data)
